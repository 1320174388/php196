   ...
   <div class="container"> 
    ...
    <nav class="topbar-nav" role="navigation"> 
     <ul class="topbar-site-nav"> 
      ...
      <li><a class="tnav-link" href="#">礼品中心</a></li> 
      <li><a id="tdp_link" class="tnav-link hide" href="#" target="_blank">附近团购</a></li> 
      <li><a class="tnav-link" href="#">联系客服</a></li> 
     </ul> 
     ...
     <div id="topbar_username" class="eleme_dropdown topbar-user-nav hide"> 
      ...
      <ul class="e_dropdown topbar-user-dropdown"> 
       <li><a class="tuser-link" href="{{ url('/home/personal') }}"><i class="glyph-user"></i>个人中心</a></li> 

			...
			<div class="finance-content-middle-form finance-add-agent-ad">
				...
				<div class="finance-add-agent">
					...
					<form action="{{ url('/admin/user/insert') }}" enctype="multipart/form-data" method="post">
						...
						<p>
							<label>密码：</label>
							<input type="password" value="{{ old('password') }}" class="form-control" name="password" placeholder="请输入密码">
							<em>*(必填)</em>
						</p>
						<p>
							<label>确认密码：</label>
							<input type="password" value="{{ old('re-password') }}" class="form-control" name="re-password" placeholder="确认输入密码">
							<em>*(必填)</em>
						</p>
						<p>
							<label>手机号：</label>
							<input type="text" value="{{ old('phone') }}" class="form-control" name="phone" placeholder="请输入手机号">
							<em>*(必填)</em>
						</p>
						
						<p>
							<label>邮箱：</label>
							<input type="text" value="{{ old('email') }}" class="form-control" name="email" placeholder="请输入邮箱">
							<em>*(必填)</em>
						</p>

...
<style>
	...
	.waveWrapperInner{position: absolute;width: 100%;overflow: hidden;height: 100%;bottom: -1px;background-image: url(images/404bg.svg);background-repeat: no-repeat;background-size:100%;}
...
<body>
<div class="wavetext" style="margin-bottom: 250px;">
	<div class="wavetop">
		<div class="wavelx">
			<img src="{{ url('/admin/images/404.svg') }}">
		</div>
		<div class="wavets">
			em~ 此路不通！
		</div>
	</div>
	<span class="wavecz">你的权限不够，请返回~</span>
	<div class="waveqcz">
	</div>
...
<div class="waveWrapper waveAnimation">
	<div class="waveWrapperInner bgTop">
		<div class="wave waveTop" style="background-image: url('/admin/images/wave-top.png')">
		</div>
	</div>
	<div class="waveWrapperInner bgMiddle">
		<div class="wave waveMiddle" style="background-image: url('/admin/images/wave-mid.png')">
		</div>
	</div>
	<div class="waveWrapperInner bgBottom">
		<div class="wave waveBottom" style="background-image: url('/admin/images/wave-bot.png')">
		</div>
	</div>
</div>
</body>

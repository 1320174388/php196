     ...
     <div class="rst-header-detail rst-header-dropdown"> 
      <section class="rst-header-rating group"> 
       ...
       <ul class="rating-diagram header"> 
        <li class="diagram-item"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i></span> <span class="bar" style="width:{{ (($val['10']/$num)*100)/2  }}px;"></span> {{ round((($val['10']/$num)*100)) }}% </li> 
        <li class="diagram-item"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star off">★</i></span> <span class="bar" style="width:{{ (($val['8']/$num)*100)/2  }}px;"></span> {{ round((($val['8']/$num)*100)) }}% </li> 
        <li class="diagram-item"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i></span> <span class="bar" style="width:{{ (($val['6']/$num)*100)/2  }}px;"></span> {{ round((($val['6']/$num)*100)) }}% </li> 
        <li class="diagram-item"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i></span> <span class="bar" style="width: {{ (($val['4']/$num)*100)/2  }}px;"></span> {{ round((($val['4']/$num)*100)) }}% </li> 
        <li class="diagram-item"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i><i class="glyph-rating-star off">★</i></span> <span class="bar" style="width:{{ (($val['2']/$num)*100)/2  }}px;"></span> {{ round((($val['2']/$num)*100)) }}% </li> 
       </ul> 
      </section> 
  ...
  <div class="container"> 
   <div class="restaurant-main"> 
    ...
    <b style="font-size:15px">满意度：</b>
        <ul id="ul">
          <li class="light cli"><a class="a_hide" href="javascript:;">2</a></li>
          <li class="cli"><a class="a_hide" href="javascript:;">4</a></li>
          <li class="cli"><a class="a_hide" href="javascript:;">6</a></li>
          <li class="cli"><a class="a_hide" href="javascript:;">8</a></li>
          <li class="cli"><a class="a_hide" href="javascript:;">10</a></li>
        </ul>
     <form>
